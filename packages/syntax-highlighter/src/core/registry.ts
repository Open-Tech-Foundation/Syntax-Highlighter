...
const aliasToCanonical: Record<string, string> = {
  ...
  "jl": "julia",
  "asm": "assembly", "nasm": "assembly", "yasm": "assembly", "gas": "assembly",
  "nimrod": "nim",
  "cr": "crystal",
  "jade": "pug",
  "hbs": "handlebars", "mustache": "handlebars",
  "jinja2": "jinja", "django": "jinja",
  "nixos": "nix",
  "bat": "batch", "cmd": "batch", "batchfile": "batch", "dos": "batch",
  "git-config": "gitconfig", "gitignore": "gitconfig", "gitattributes": "gitconfig",
  "github-actions": "actions", "gha": "actions", "workflow": "actions",
  "k8s": "kubernetes", "k8s-manifest": "kubernetes", "k8s-yaml": "kubernetes",
  "restructuredtext": "rst", "rest": "rst",
  "adoc": "asciidoc", "asciidoctor": "asciidoc",
    "ml": "ocaml",
  "pas": "pascal",
  "cl": "lisp", "common-lisp": "lisp",
  "scm": "scheme",
  "st": "smalltalk",
  "dlang": "d",
  "vlang": "v",
  ...
  "apacheconf": "apache", "htaccess": "apache",
  "wat": "wasm",
  "stfs": "stf", "stf-schema": "stf", "webassembly": "wasm",
