...
- **LOW:** Applied the shared dark Open Tech Foundation footer to the landing page and documentation layout.
...
- **MEDIUM:** Aligned the website with the org docs template (version badge, pagefind search, Home/Docs/API nav) and wrote comprehensive documentation: introduction, installation, quick start, getting started, renderers, API reference, languages, and themes.
- **LOW:** Unified the landing header/footer with the docs layout (full-width navbar and shared org-logo footer, API kept in the docs sidebar), added the org logo favicon, and ignored the `website/.otfw/` dev cache.
